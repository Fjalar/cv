...
= Student Activities
  ...
  I built and maintained a website and moderated a forum for participants of a volunteer-run scientific conference, and learned how to work closely in a small team overseeing a larger project.

  == #cv_entry("Event Organizer", "Jan 2022 - Jan 2024", "F-Guild at Engineering Faculty")
  I organized in-person video game events and tournaments, as well as moderated an online gaming community. In this role, I learned to take a leading role in planning and execution of events with a short schedule.

  == #cv_entry("Sustainability Person", "Mar 2022 - May 2022", "Lundakarnevalen")
  As a member of the Ministry of Sustainability, I solved sustainability challenges in planning a \~500'000 visitor carnival called Lundakarnevalen, and was also in charge of waste disposal logistics for the event. This taught me both the important of good planning, but also the importance of improvising when things don't go according to plan.
...
#grid(
  columns: (1fr, 1fr),
  [
    *Programming languages:* \ #box_elements(([#fa-icon("java", size: 7.5pt) #monospace("Java")], [#box(image("c++.svg", height: 7.5pt)) #monospace("C++")], [#box(image("c.svg", height: 7.5pt))], [#fa-icon("rust", size: 7.5pt) #monospace("Rust")], [#fa-icon("python", size: 7.5pt) #monospace("Python")], [#box(image("matlab.svg", height: 7.5pt)) #monospace("MATLAB")]))\
  ],
  [
    *Tools:* \ #box_elements(([#fa-linux(size: 7.5pt) Linux], [#fa-git-alt(size: 7.5pt) git], [#fa-github(size: 7.5pt) GitHub CI/CD], LaTeX, Typst))\
  ]
)
